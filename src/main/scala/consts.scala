...
//   val uopSRET = 40.U(UOPC_SZ.W)
   ...
   val uopFCVT_S_W  = 76.U(UOPC_SZ.W)
   val uopFCVT_S_WU = 77.U(UOPC_SZ.W)
   val uopFCVT_S_L  = 78.U(UOPC_SZ.W)
   val uopFCVT_S_LU = 79.U(UOPC_SZ.W)
   val uopFCVT_D_W  = 80.U(UOPC_SZ.W)
   val uopFCVT_D_WU = 81.U(UOPC_SZ.W)
   val uopFCVT_D_L  = 82.U(UOPC_SZ.W)
   val uopFCVT_D_LU = 83.U(UOPC_SZ.W)


   val uopFCVT_W_S  = 84.U(UOPC_SZ.W)
   val uopFCVT_WU_S = 85.U(UOPC_SZ.W)
   val uopFCVT_L_S  = 86.U(UOPC_SZ.W)
   val uopFCVT_LU_S = 87.U(UOPC_SZ.W)
   val uopFCVT_W_D  = 88.U(UOPC_SZ.W)
   val uopFCVT_WU_D = 89.U(UOPC_SZ.W)
   val uopFCVT_L_D  = 90.U(UOPC_SZ.W)
   val uopFCVT_LU_D = 91.U(UOPC_SZ.W)

   val uopFEQ_S     = 92.U(UOPC_SZ.W)
   val uopFLT_S     = 93.U(UOPC_SZ.W)
   val uopFLE_S     = 94.U(UOPC_SZ.W)
   val uopFEQ_D     = 95.U(UOPC_SZ.W)
   val uopFLT_D     = 96.U(UOPC_SZ.W)
   val uopFLE_D     = 97.U(UOPC_SZ.W)

   val uopFCLASS_S  = 98.U(UOPC_SZ.W)
   val uopFCLASS_D  = 99.U(UOPC_SZ.W)

   val uopFMIN_S    = 100.U(UOPC_SZ.W)
   val uopFMAX_S    = 101.U(UOPC_SZ.W)
   val uopFMIN_D    = 102.U(UOPC_SZ.W)
   val uopFMAX_D    = 103.U(UOPC_SZ.W)

   val uopFADD_S    = 104.U(UOPC_SZ.W)
   val uopFSUB_S    = 105.U(UOPC_SZ.W)
   val uopFMUL_S    = 106.U(UOPC_SZ.W)
   val uopFADD_D    = 107.U(UOPC_SZ.W)
   val uopFSUB_D    = 108.U(UOPC_SZ.W)
   val uopFMUL_D    = 109.U(UOPC_SZ.W)

   val uopFMADD_S   = 110.U(UOPC_SZ.W)
   val uopFMSUB_S   = 111.U(UOPC_SZ.W)
   val uopFNMADD_S  = 112.U(UOPC_SZ.W)
   val uopFNMSUB_S  = 113.U(UOPC_SZ.W)
   val uopFMADD_D   = 114.U(UOPC_SZ.W)
   val uopFMSUB_D   = 115.U(UOPC_SZ.W)
   val uopFNMADD_D  = 116.U(UOPC_SZ.W)
   val uopFNMSUB_D  = 117.U(UOPC_SZ.W)

   val uopFDIV_S    = 118.U(UOPC_SZ.W)
   val uopFDIV_D    = 119.U(UOPC_SZ.W)
   val uopFSQRT_S   = 120.U(UOPC_SZ.W)
   val uopFSQRT_D   = 121.U(UOPC_SZ.W)

   val uopSYSTEM    = 122.U(UOPC_SZ.W) // pass uop down the CSR pipeline and let it handle it
...
trait RISCVConstants
{
   ...
   def ComputeBranchTarget(pc: UInt, inst: UInt, xlen: Int, coreInstBytes: Int): UInt =
   {
      ...
      ((pc + Sext(b_imm32, xlen)).asSInt & (-coreInstBytes).S).asUInt
   }
   def ComputeJALTarget(pc: UInt, inst: UInt, xlen: Int, coreInstBytes: Int): UInt =
   {
      ...
      ((pc + Sext(j_imm32, xlen)).asSInt & (-coreInstBytes).S).asUInt
   }
}
...
trait ExcCauseConstants
{
   ...
   val MINI_EXCEPTION_MEM_ORDERING = 13.U
   // an instruction needs to be replayed (e.g., I$ asks for a replay)
   val MINI_EXCEPTION_REPLAY = 14.U
